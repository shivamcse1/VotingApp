...
class NumberOtpVerificationScreen extends StatefulWidget {
  const NumberOtpVerificationScreen({super.key});

  @override
  State<NumberOtpVerificationScreen> createState() => NumberOtpVerificationScreenState();
}

class NumberOtpVerificationScreenState extends State<NumberOtpVerificationScreen> {
           ...
           child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text("Enter the 4 digit code that you received on your SMS.",
                textAlign: TextAlign.center,
